...
// 1. Fix the checklistType issue
const target = "  const typeEq = equipement.type_equipement || 'AUTRE';";
const replacement = "  const typeEq = equipement.type_equipement || 'AUTRE';\n  const checklistType = mission?.checklist_type || 'MSANTE_STANDARD';\n  const feuilleAmee = feuille || '';";
...
console.log("Replaced components with function calls and injected checklistType successfully!");
